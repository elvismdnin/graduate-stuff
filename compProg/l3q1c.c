...
C ́odigo ASM abaixo substitui a linha acima, sem alocar registro para passagem de vari ́avel e constante;

Vari ́avel errno listada como entrada e como sa ́ıda! Aten ̧c~ao!
...
:[arq]"=r"(arq) // lista de sa ́ıda

:[erro]"r"(errno), [nome]"r"(argv[1]), [flag]""(O_RDONLY) // lista de entrada
